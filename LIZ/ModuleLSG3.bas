...
Public Const MAIN_SHEET_NAME As String = "ЭФ_Лизинг"
Public Const ATTR_CODE_ROW As Long = 8
Public Const DICT_CODE_ROW As Long = 10
Public Const FIRST_INPUT_ROW As Long = 11
